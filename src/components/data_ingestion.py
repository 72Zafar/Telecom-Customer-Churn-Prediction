...
class DataIngestion:
    def __init__(self, data_ingestion_config: DataIngestionConfig = DataIngestionConfig()):
        """
        :param data_ingestio_confog: configuration for data ingestion
        """
        try:
    ...
    def split_data_as_train_test(self, dataframe: DataFrame)-> None:
        ...
        Description :  This method splits the dataframe  into train set and test set on the basis of train_test_split_ratio

        Output :  Folder is created in s3 bucket
        on Failure :  Write am exception log and then raise then an exception
        """
        try:
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:
        ...
        Output : train set test set are returned as the artifact of data ingestion component
        on Failure : Write an exception log and then raise an exception
        """
